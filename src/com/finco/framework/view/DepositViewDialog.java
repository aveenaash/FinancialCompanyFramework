...
public class DepositViewDialog extends javax.swing.JDialog
{
    

    private FinancialAppForm parentframe;
    private String accnr;
    
	public DepositViewDialog(FinancialAppForm parent, String aaccnr)
	{
		super(parent);
		parentframe=parent;
		accnr=aaccnr;
