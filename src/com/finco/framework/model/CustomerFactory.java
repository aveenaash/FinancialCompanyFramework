...
public class CustomerFactory {
	...
	public static Customer getInstance(String customerType, String name,
			String street, String city, String state, String zip,
			Date birthdate, String email) {

		if (customerType.equalsIgnoreCase("PERSONAL")) {
			Customer customer = new Personal(name, street, city, state, zip,
					birthdate, email);
			return customer;
		} else if (customerType.equalsIgnoreCase("COMPANY")) {
			Customer customer = new Company(name, street, city, state, zip,
					email);
			return customer;
		}
	...
	public static Customer getInstance(String customerType) {
		...
		if (customerType.equalsIgnoreCase("PERSONAL")) {
			Customer customer = new Personal();
			return customer;
		} else if (customerType.equalsIgnoreCase("COMPANY")) {
